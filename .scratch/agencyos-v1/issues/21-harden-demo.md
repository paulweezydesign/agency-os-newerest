...
- [x] Seed script creates sample Clients, Projects, Tasks, and agent artifacts
- [x] Demo script covers lead → onboard and brief → SOW → scaffold paths
- [x] `docs/architecture.md`, `docs/workflows.md`, and `docs/runbooks.md` are complete enough to operate
- [x] External API retries/timeouts/circuit-breaker behavior is audited
- [x] `lint`, `typecheck`, `test`, and `build` all pass
